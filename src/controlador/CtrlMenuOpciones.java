...
public class CtrlMenuOpciones implements MouseListener, ActionListener, WindowListener {
	...
	public void mouseClicked(MouseEvent e) {
		if (e.getSource() == menu.btnInventario) {
			CtrlProducto.createInstanciaController(menu, productosModel, permiso);
			CtrlCategoria.createInstanciaController(menu, categoriasModel);
			CtrlMarca.createInstanciaController(menu, marcasModel);
		...
		if (e.getSource() == menu.btnClientes) {
			CtrlClientes.createInstanciaController(menu, clientesModel);
			CtrlCreditos.createInstanciaController(menu, creditosModel);
...
//                menu.lblTituloDeVentanas.setText("");
	...
	public void devolverProductoStock() {
		...
		for (int i = 0; i < filas; i++) {
			...
			this.productosModel.AgregarProductoStock(id, cantidad);
		}
	}

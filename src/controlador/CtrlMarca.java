...
public class CtrlMarca implements ActionListener, CaretListener {
	...
	private static CtrlMarca instancia = null;
	IMenu menu;
	Marca marca;
	String id;
	DefaultTableModel modelo;

	private CtrlMarca(IMenu menu, Marca L) {
		this.menu = menu;
		this.marca = L;
		this.id = null;
	...
	public static void createInstanciaController(IMenu menu, Marca marcasController){
		if(instancia == null)	
			instancia = new CtrlMarca(menu,marcasController);
	}

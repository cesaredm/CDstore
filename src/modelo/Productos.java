...
public class Productos extends Conexiondb {
    ...
    public void Guardar(String codigoBarra, String nombre, String precioCompra, String monedaCompra, String precioVenta, String monedaVenta, String precioMinimo,Date fechaVencimiento, String stock, String categoria, String laboratorio, String ubicacion, String descripcion) {
        cn = Conexion();
        this.consulta = "INSERT INTO productos(codigoBarra, nombre, precioCompra, monedaCompra, precioVenta, precioMinimo, monedaVenta, fechaVencimiento, stock, categoria, marca, ubicacion, descripcion) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?)";
    ...
    public void Actualizar(String id, String codigoBarra, String nombre, String precioCompra, String monedaCompra, String precioVenta, String monedaVenta ,String precioMinimo ,Date fechaVencimiento, String stock, String categoria, String laboratorio, String ubicacion, String descripcion) {
        cn = Conexion();
        this.consulta = "UPDATE productos SET codigoBarra=?, nombre=?, precioCompra=?, monedaCompra=?, precioVenta=?, precioMinimo=?, monedaVenta=?, fechaVencimiento=?, stock=?, categoria=?, marca=?, ubicacion=?, descripcion=? WHERE id = ?";
    ...
    public DefaultTableModel Consulta(String buscar) {
        ...
        String[] titulos = {"Id", "Codigo Barra", "Nombre", "precioCompra", "Moneda", "precioVenta", "Moneda", "P. venta Min", "Descripción" ,"Fecha Vencimiento", "Stock", "Categoria", "marca", "Ubicación"};

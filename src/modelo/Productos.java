...
public class Productos extends Conexiondb {
    ...
    public DefaultTableModel Consulta(String buscar) {
        ...
        String[] titulos = {"Id", "Codigo Barra", "Nombre", "precioCompra", "Moneda", "precioVenta", "Moneda", "P. venta Min", "Descripción" ,"Fecha Vencimiento", "Stock", "Categoria", "marca", "Ubicación", "Utlidad%"};
